...
This script implements transfer learning (warm-start) to train PINN models on
the highest Gamma and M parameter values using pre-trained models as starting points.

Features:
1) Output folder created in same directory as script
2) Output root folder: runs_PINN_transfer_learning_highest_Gamma_M
...
"""
Transfer learning for the extreme case when both M and Gamma are high, using best 
optimized model from grid search + weighting loss sensitivity.
"""
...
def main():
    ...
    TRANSFER_OUT_ROOT = script_dir / "runs_PINN_best_grid_search_transfer_learning_highest_Gamma_M"
...
>>>>>>> a3aa7e2bb0a5f6dba1a84d97ac65c798bd6d7f75
    ...
    # ------------------------------------------------------------------
    targets = [
        {"M": 19.0, "Gamma": 49.0, "pair_index": 1}
    ]
