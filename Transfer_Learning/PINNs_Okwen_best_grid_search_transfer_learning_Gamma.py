...
2) Output root folder: runs_PINN_transfer_learning_Gamma
...
def find_best_pretrained_pair_folder(grid_search_root, run_dir_name):
    ...
    # Sort by pair number and take the first available one
    pair_folders.sort()
...
def main():
    ...
    TRANSFER_OUT_ROOT = script_dir / "runs_PINN_best_grid_search_transfer_learning_Gamma"
...
>>>>>>> a3aa7e2bb0a5f6dba1a84d97ac65c798bd6d7f75
    ...
    targets = [
        ...
        {"M": 6.0, "Gamma": 17.0, "pair_index": 2},
        {"M": 6.0, "Gamma": 33.0, "pair_index": 3},
    ]
