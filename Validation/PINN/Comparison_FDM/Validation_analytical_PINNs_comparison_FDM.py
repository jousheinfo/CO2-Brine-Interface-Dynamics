...
# Output folder: runs_validation_PINN_comparison_FDM
#
...
# ============================================================
class PINNSolver:
    def __init__(self, M_values, Gamma_values, layers, activation_function, optimizer_name, output_dir, chi_min=0.0, N=500, epochs=50000, learning_rate=1e-5, tol=1e-5, init_seed=42, snapshot_every=1000, error_eval_points=500, additional_epochs_after_tolerance=5000):
        super().__init__()
...
if __name__ == "__main__":
    ...
    main_output_dir = "runs_validation_PINN_comparison_FDM"
    ...
    df.to_csv(os.path.join(main_output_dir, "results_summary_validation_PINN_comparison_FDM.csv"), index=False)
    ...
    print("Saved CSV:", os.path.join(main_output_dir, "results_summary_validation_PINN_comparison_FDM.csv"))
